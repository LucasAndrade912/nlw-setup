...
import { HabitsList } from './HabitsLits'
...
export function HabitDay({ date, defaultCompleted = 0 , amount = 0 }: HabitDayProps) {
  ...
  return (
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Content className="min-w-[320px] p-6 rounded-lg bg-zinc-900 flex flex-col focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background">
